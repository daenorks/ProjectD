...
public class RotatedIcon implements Icon {
	...
	/**
	 * Create a RotatedIcon. The icon will rotate about its center. This constructor
	 * will automatically set the Rotate enum to ABOUT_CENTER.
	 *
	 * @param icon    the Icon to rotate
	...
	/**
	 * Set the degrees of rotation. Only used for Rotate.ABOUT_CENTER. This method
	 * only sets the degress of rotation, it will not cause the Icon to be
	 * repainted. You must invoke repaint() on any component using this icon for it
	 * to be repainted.
	 *
	 * @param degrees the degrees of rotation
	 */
	...
	/**
	 * Is the image circular or rectangular? Only used for Rotate.ABOUT_CENTER. When
	 * true, the icon width/height will not change as the Icon is rotated.
	 *
